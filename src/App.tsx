                ...
                <section className="bg-slate-850/50 text-slate-300 rounded-xl p-4 border border-slate-800 font-mono text-[11px]">
                  <div className="flex gap-3">
                    ...
                    <div className="space-y-1">
                      <p className="font-bold text-white uppercase tracking-wider text-[10px]">Offline Secure Sandbox</p>
                      <p className="text-slate-400 leading-relaxed text-[10.5px]">
                        Fully sandboxed secure offline environment, running entirely in your browser using local storage for high durability without external cloud dependencies.
                      </p>
                    </div>
                  </div>
                </section>
