...
// API key. API keys should be stored in Cloud Secret Manager so that access
// to these sensitive values can be controlled. defineSecret does this for
// you automatically. If you are using Google Developer API (googleAI) you
// can get an API key at https://aistudio.google.com/app/apikey
...
// and logs to Google Cloud Observability. See
